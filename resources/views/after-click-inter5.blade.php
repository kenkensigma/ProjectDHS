    ...
    <div class="container">
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('Students receive mentorship from experienced managers and trainers within the partner hotel chains.') }}</p>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('Students rotate through departments, including front office, housekeeping, food and beverage, and guest relations, building a well-rounded skill set.') }}</p>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('Upon completion, students receive a certificate from both Denpasar Hotel School and the partnering hotel, which can boost their global employability.') }}</p>
            </div>
