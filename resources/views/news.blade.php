...
<body>
    ...
    <div class="jumbotron">
      ...
      <div class="overlay">
          ...
          <h1 data-aos="fade-in" data-aos-duration="1200" data-aos-delay="600">{{ $translator->translate('NEWS') }}</h1>
          <div class="kotak"></div>
      </div>
  </div>
    ...
    <div class="container-judul">
        <h1 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('HOT NEWS') }}</h1>
    </div>
...
<div class="container-news">
    <h1 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('RECENT NEWS') }}</h1>
</div>

    <div class="container-allnews" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
            @foreach ($news as $item)
            @if ($item->status == 1) {{-- Hanya tampilkan berita dengan status "Show" --}}
                <div class="card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                    <a href="{{ route('news.detail', ['id' => $item->id]) }}">
                    <img alt="{{ $item->caption_image }}" height="400" src="{{ url("storage/{$item->photo}") }}" width="600"/>
                    <div class="info">
                        <span>
