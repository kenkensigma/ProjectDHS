        ...
        <div class="container">
            <div class="card"  data-aos="fade-left" data-aos-duration="1200" data-aos-delay="300">
                <div class="card-content">
                    ...
                    <p>{{ $translator->translate('The Certificate of Hospitality Management provides training in hotel management, customer service, event planning, and leadership. It prepares individuals for managerial roles in the hospitality industry, focusing on business strategies, staff management, and quality service.') }}</p>
                </div>
            ...
            <div class="card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    ...
                    <p>{{ $translator->translate('The Certificate of Advanced Culinary Arts at Denpasar Hotel School refines culinary skills, focusing on advanced techniques, creative plating, menu development, and international cuisine. Led by experienced chefs, the program prepares participants for elevated roles in high-end kitchens and gastronomy.') }}</p>
                </div>
            ...
            <div class="card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    ...
                    <p>{{ $translator->translate('Provides knowledge of tourism principles, event planning, and logistics. This program prepares students for roles in event coordination, tour operations, and hospitality event management.') }}</p>
                </div>
            ...
            <div class="card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    ...
                    <p>{{ $translator->translate('The Certificate of Food and Beverage Service at Denpasar Hotel School trains participants in service skills, restaurant operations, and customer interaction, preparing them for roles in restaurants, hotels, and catering services with a focus on professionalism and practical experience.') }}</p>
                </div>
