...
@endphp
  ...
  <head>
    ...
    <link
      rel="shortcut icon"
      type="education"
      href="img/logo_192509100957_ 1.png"
    />
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;200;500;600;700;800&display=swap" rel="stylesheet"/>
    <link rel="stylesheet" href="/css/footer.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poltawski+Nowy:ital,wght@0,200..700;1,200..700&display=swap" rel="stylesheet">
  ...
  <div class="jumbotron">
        ...
        <div class="overlay-jumbo">
            ...
            <h1 data-aos="fade-in" data-aos-duration="1200" data-aos-delay="600">{{ $translator->translate('VIDEO') }}</h1>
            <div class="kotak"></div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="top-video">
              <h1 data-aos="fade-up" data-aos-duration="1200" >{{ $translator->translate('OUR VIDEOS') }}</h1>
                ...
                <iframe src="https://www.youtube.com/embed/u8XTRYY7zx8?si=15oGbXMPxbt8XSBN&amp;controls=0" title="YouTube video player" frameborder="0"  allowfullscreen></iframe>
                </div>
                <div class="video" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                <iframe src="https://www.youtube.com/embed/QkML_bJYlME?si=lqVYrj9dAePCh-qS&amp;controls=0" title="YouTube video player" frameborder="0" allowfullscreen></iframe> 
                </div>
                <div class="video" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                <iframe src="https://www.youtube.com/embed/n3UtnWKhrBI?si=Ib3oXwcbHBkgNSzm&amp;controls=0" title="YouTube video player" frameborder="0"  allowfullscreen></iframe>
                </div>
                <div class="video" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                <iframe src="https://www.youtube.com/embed/liK2t1S3gEQ?si=UQijCmqBrM3mJWIg&amp;controls=0" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
                </div>
                </div>
                </div>
            </div>
