...
<section class="started">
  <div class="text-started">
    <div class="container-title1">
      <h2 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Flexible Hourly Training for Hospitality Professionals') }} </h2>
    </div>
    <div class="started-wrapper">
      <p data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Denpasar Hotel School offers a flexible hourly-based training program designed to accommodate the specific needs of hospitality businesses. Whether your team needs a brief refresher or specialized training in a particular area, this program allows businesses to select individual topics and schedule sessions that best fit their operational hours. From front desk operations to food service excellence, this program is tailored to improve key hospitality skills in manageable time slots. With a customizable duration ranging from 2 to 40 hours, businesses can choose the training intensity that best suits their needs.
        ') }} </p>
    </div>
  </div>
</section>  
...
<section class="why">
  <div class="text-why">
    <div class="container-title2">
      <h2 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('WHY CHOOSE THIS PROGRAM') }} </h2>
    </div>
    <div class="why-wrapper">
      <p data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('This hourly-based program offers flexibility and precision, allowing your team to enhance essential hospitality skills without committing to a long-term course.') }} </p>
    </div>
  </div>
  ...
  <div class="features">
    <div class="feature" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
      <h3>{{ $translator->translate('
        ...
        <p>{{ $translator->translate('
          Pay for only the hours you need, making it an affordable option for small teams or businesses.
          ') }} </p>
    </div>
    ...
    <div class="feature" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
     <h3>{{ $translator->translate('
      ...
      ') }} </h3>
     <p>{{ $translator->translate('
      Designed to fit around your team’s schedule, minimizing disruption to hotel or restaurant operations.
      ') }} </p>
    </div>
    ...
    <div class="feature" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
     <h3>{{ $translator->translate('
      ...
      ') }} </h3>
     <p>{{ $translator->translate('
      Ideal for targeted training on specific skills or areas of improvement.
      ') }} </p>
    </div>
</section>  
...
<section class="target">
  ...
  <div class="container-title3">
    <h2 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('TARGET AUDINCE') }} </h2>
  </div>
</div>
  <div class="audience">
    <div data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
     ...
     <p>{{ $translator->translate('
      Hotel staff, restaurant employees, and other hospitality professionals
      ') }} </p>
    </div>
    <div data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
      <i class="fa-solid fa-hourglass-half"></i>
     <p>{{ $translator->translate('
      Individuals seeking focused, short-term skill enhancements
      ') }} </p>
    </div>
    <div data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
      <i class="fa-solid fa-person-chalkboard"></i>
     <p>{{ $translator->translate('
       Hospitality businesses aiming to train staff without interrupting daily operations
       ') }} </p>
    </div>
   </div>
</section>
...
<section id="program">
  <div class="container-title4">
    <h2 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Hourly Option') }} </h2>
  </div>
  <div class="program">
    <div class="program-text">
      <div class="program-title">
        <h1 data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate(' Front Desk Operations (2-4 hours)') }} </h1>
      </div>
      
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Guest Check-in/Check-out Procedures') }} </p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Reservation System Introduction') }} </p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Handling Complaints and Guest Issues') }} </p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Guest Communication Etiquette') }} </p>
  ...
  <div class="program">
    ...
    <div class="program-text">
      <h1 data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Customer Service Excellence (2-3 hours)') }} </h1>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Professional Communication Techniques') }} </p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Building Positive Guest Relationships') }} </p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Handling Difficult Situations') }} </p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Creating Memorable Experiences for Guests') }} </p>
  ...
  <div class="program">
    <div class="program-text">
      <div class="program-title">
      <h1 data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Food and Beverage Service (3-4 hours)') }} </h1>
      </div>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Table Service Etiquette') }} </p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Menu Knowledge and Food Pairing') }} </p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Upselling Techniques') }} </p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Bar Service Fundamentals (Cocktails, Wine Pairing, etc.)') }} </p>
  ...
  <div class="program">
    ...
    <div class="program-text">
      <h1 data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Housekeeping and Room Management (3-4 hours)') }} </h1>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Room Preparation and Maintenance Best Practices') }} </p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Cleaning Standards and Hygiene') }} </p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Inventory Management for Housekeeping') }} </p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Guest Room Personalization') }} </p>
  ...
  <div class="program">
    <div class="program-text">
      <div class="program-title">
        <h1>{{ $translator->translate('Leadership and Team Building (4-6 hours)') }} </h1>
      </div>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Effective Leadership in Hospitality') }} </p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Building Team Cohesion and Motivation') }} </p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Conflict Resolution Techniques') }} </p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Time Management and Task Delegation') }} </p>
  ...
  <div class="program">
    ...
    <div class="program-text">
      <h1 data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Health, Safety, and Hospitality Laws (2-3 hours)') }} </h1>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Safety Protocols and Emergency Procedures') }} </p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Hygiene Standards and Compliance') }} </p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Labor Laws in Hospitality') }} </p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Basic First Aid and CPR') }} </p>
    </div>
      </div>
      ...
      <div class="program">
        <div class="program-text">
          <div class="program-title">
            <h1  data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Sales and Upselling Techniques (2-3 hours)') }} </h1>
          </div>
          <p  data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Understanding Upselling and Cross-selling') }} </p>
          <p  data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Effective Sales Techniques in Hospitality') }} </p>
          <p  data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Maximizing Revenue without Compromising Service Quality') }} </p>
      ...
      <div class="program">
        ...
        <div class="program-text">
          <h1  data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Event Planning Essentials (3-4 hours)') }} </h1>
          <p  data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Event Coordination Basics') }} </p>
          <p  data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Guest List Management and Scheduling') }} </p>
          <p  data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Vendor Relations and Negotiations') }} </p>
          <p  data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('- Budgeting for Small Events') }} </p>
        </div>
          </div>
...
<section class="highlights">
    <div class="container-title5">
      <h2  data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('HIGHLIGHTS') }} </h2>
    </div>

    <div class="container-card">
      <div class="card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
          <h3>{{ $translator->translate('Flexible Scheduling') }} </h3>
          <p>{{ $translator->translate('Choose from 2-hour to 6-hour sessions based on your staff’s availability and needs.') }} </p>
      </div>
      <div class="card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
          <h3>{{ $translator->translate('Tailored Content') }} </h3>
          <p>{{ $translator->translate('Select specific modules based on the challenges or goals your team wants to address.') }} </p>
      </div>
      <div class="card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
          <h3>{{ $translator->translate('Hands-On Training') }} </h3>
          <p>{{ $translator->translate(' Interactive, practical training that staff can apply immediately in the workplace.') }} </p>
      </div>
      <div class="card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
          <h3>{{ $translator->translate('Certified Trainers') }} </h3>
          <p>{{ $translator->translate('Learn from experienced trainers with real-world expertise in the hospitality sector.') }} </p>
      </div>
  </div>
</section> 
