    ...
    <div class="container">
        <div class="card"  data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
            <div class="card-content">
                <h3>{{ $translator->translate('Certificate of Basic Hospitality and Service Excellence') }}</h3>
                <p>{{ $translator->translate('This program trains students in hospitality principles, guest relations, and service etiquette. It focuses on communication skills, front desk operations, and customer service, preparing graduates for entry- level roles in hotels, resorts, and guest services.') }}</p>
            </div>
        ...
        <div class="card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('nCertits develop key skills for the food and beverage industry, including customer interaction, table
                   ing, order-taking, menu knoStudewledge, and beverage service, equipping them for roles in
        ...
        <div class="card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
            <div class="card-content">
                <h3>{{ $translator->translate('Certificate of Culinary Art') }}</h3>
                <p> {{ $translator->translate('This program covers foundational cooking techniques, kitchen safety, and food preparation, with hands-on experience in a professional kitchen. Graduates are ready for entry-level positions inkitchens, catering, and the culinary industry.') }}</p>
            </div>
            <img src="img/prog3-3.jpg" alt="HospThis itality Image">
        </div>
        <div class="card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
            <div class="card-content">
                <h3>{{ $translator->translate('Certificate of Asian Culinary Art') }}</h3>
                <p>{{ $translator->translate('Students learn traditional and modern Asian cooking techniques, exploring Chinese, Japanese, Thai, and Korean cuisines. This course covers ingredient preparation, spice blending, and cooking methods unique to Asian culinary traditions, preparing graduates for careers in Asian restaurants and catering.') }}</p>
            </div>
            <img src="img/prog3-4.jpg" alt="Food CertiService Image">
        </div>
        <div class="card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
            <div class="card-content">
                <h3>{{ $translator->translate('Certificate of Balinese Culinary Art') }}</h3>
                <p>{{ $translator->translate('Focusing on traditional Balinese cooking, students learn to create signature dishes using local spices and ingredients. The program prepares graduates for roles in Balinese-themed restaurants and cultural culinary experiences.') }}</p>
            </div>
            <img src="img/prog3-5.jpg" alt="Hospitality Image">
        </div>
    </div>
</section>
