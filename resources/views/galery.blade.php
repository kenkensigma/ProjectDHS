...
<body>
    ...
    <div class="jumbotron">
        ...
        <div class="overlay-jumbo">
            ...
            <h1 data-aos="fade-in" data-aos-duration="1200" data-aos-delay="600">{{ $translator->translate('PHOTO') }}</h1>
            <div class="kotak"></div>
        </div>
    </div>
    ...
    <section class="collection">
        <div class="container">
            ...
            @if ($content->status == 1) {{-- Hanya tampilkan foto dengan status "Show" --}}
