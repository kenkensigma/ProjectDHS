            ...
            <ul class="nav-links left">
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="{{ route('contact') }}">{{ $translator->translate('Contact Us') }}</a>
                        <a href="{{ route('team') }}">{{ $translator->translate('Our Team') }}</a>                        
                        <a href="{{ route('galery') }}">{{ $translator->translate('Foto') }}</a>                        
                        <a href="{{ route('video') }}">{{ $translator->translate('Videos') }}</a>                        
                    </div>
                <li class="dropdown">
                    <a href="#program" class="dropbtn">{{ $translator->translate('Program ') }}<i
                            class="fas fa-chevron-down"></i></a>
                    <div class="dropdown-content">
                        <a href="{{ route('national') }}">{{ $translator->translate('National Program') }}</a>
                        <a href="{{ route('international') }}">{{ $translator->translate('International Program') }}</a>
                        <a href="{{ route('tailor-program') }}">{{ $translator->translate('Tailor-Made Program For Hospitality') }}</a>
                        <a href="{{ route('house-training') }}">{{ $translator->translate('In-House Training Program') }}</a>
                        <a href="{{ route('hourly-training') }}">{{ $translator->translate('Hourly-Based Training Program') }}</a>
                    </div>
                </li>
                <li><a href="{{ route('register') }}">{{ $translator->translate('Register') }}</a></li>
            </ul>

            <div class="logo">
                <a href="{{ route('home') }}"><img src="{{ asset('img/logo_192509100957_ 1.png') }}" alt="Logo" width="80px"></a>
            </div>

            <ul class="nav-links right">
                <li><a href="{{ route('login') }}">{{ $translator->translate('Login') }}</a></li>
                <li><a href="{{ route('news') }}">{{ $translator->translate('News & Event')}}</a></li>
...
<div class="container">
        <div class="main-content">
            ...
            <div class="news-header">{{ $translator->translate('News') }}</div>
