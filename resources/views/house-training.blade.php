...
@endphp
    ...
    <link rel="stylesheet" href="css/house-training.css" />
...
<section class="started">
  <div class="text-started">
    <div class="container-title1">
      <h2 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Professional In-House Training for Hotel and Hospitality Staff') }}</h2>
    </div>
    <div class="started-wrapper" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
      <p>{{ $translator->translate('Denpasar Hotel School offers a comprehensive in-house training program designed to upgrade the skills of hotel and hospitality staff at all levels. This program focuses on practical training that addresses the specific needs of your hotel or hospitality establishment, aiming to improve guest satisfaction, operational efficiency, and staff performance. Tailored to the unique challenges and requirements of your hotel, from front desk operations to food and beverage service, this training ensures every staff member is equipped with the skills to perform at the highest standard. With a flexible duration ranging from 1 week to 6 months, the program can be customized to meet your specific training needs.
        ') }}</p>
    </div>
  </div>
</section>  
...
<section class="why">
  <div class="text-why">
    ...
    <div class="why-wrapper" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
      <p>{{ $translator->translate('This in-house training program is designed to elevate the skills of your team, enhance your hotel’s service standards, and contribute to your long-term success in the hospitality industry.') }}</p>
    </div>
  </div>
  ...
  <div class="features">
    <div class="feature" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
      <h3>{{ $translator->translate('
        ...
        <p>{{ $translator->translate('
          The training program is tailored specifically to the needs and goals of your hotel or resort.
          ') }}</p>
    </div>
    ...
    <div class="feature" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
     <h3>{{ $translator->translate('
       ...
       ') }}</h3>
     <p>{{ $translator->translate('
      Emphasis on real-world scenarios and hands-on experience ensures that staff can immediately apply their skills.
      ') }}</p>
    </div>
    ...
    <div class="feature" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
     <h3>{{ $translator->translate('
      ...
      ') }}</h3>
     <p>{{ $translator->translate('
      Learn from industry experts who bring years of experience in the hospitality sector.
      ') }}</p>
    </div>
    ...
    <div class="feature" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
      <h3>{{ $translator->translate('
        ...
        ') }}</h3>
      <p>{{ $translator->translate('
        Your hotel will align with international hospitality practices, making it more competitive in the market.
        ') }}</p>
     </div>
     ...
     <div class="feature" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
      <h3>{{ $translator->translate('
        ...
        ') }}</h3>
      <p>{{ $translator->translate('
        Streamlined operations and more efficient workflows.
        ') }}</p>
     </div>
     ...
     <div class="feature" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
      <h3>{{ $translator->translate('
        ...
        ') }}</h3>
      <p>{{ $translator->translate('
      Investing in employee development improves morale and reduces turnover.
      ') }}</p>
     </div>
     ...
     <div class="feature" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
      <h3>{{ $translator->translate('
        ...
        ') }}</h3>
      <p>{{ $translator->translate('
        Enhanced guest experiences through well-trained staff.
        ') }}</p>
     </div>
   </div>
</section>  
...
<section class="target">
  ...
  <div class="audience">
    <div data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
     ...
     <p>{{ $translator->translate('
      Hospitality industry professionals seeking to enhance their skills
      ') }}</p>
    </div>
    ...
    <div data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
     ...
     <p>{{ $translator->translate('
       Management teams looking to improve operational efficiency and service standards
       ') }}</p>
    </div>
   </div>
...
<section id="program">
  ...
  <div class="program">
    <div class="program-text" >
      <div class="program-title" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
        <h1>{{ $translator->translate('Front Desk and Guest Relations (1 Week to 1 Month)') }}</h1>
      </div>
      
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Check-in/Check-out Procedures :') }}</span></p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Streamlining guest arrival and departure processes') }}</p>

    
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Reservation Systems :') }}</span></p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate(' Training on the use of hotel management software') }}</p>

      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Guest Communication :') }}</span></p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Enhancing verbal and written communication skills with guests') }}</p>

      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Complaint Handling :') }}</span></p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Techniques for managing difficult situations and turning complaints into opportunities') }}</p>

      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Customer Service Excellence :') }}</span></p>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Emphasis on exceeding guest expectations') }}</p>
  ...
  <div class="program">
    ...
    <div class="program-text">
      <h1 data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Leadership and Team Building for Management (1 Month)') }}</h1>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Cleaning Standards:') }}</span></p></li>
    <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Training on international hygiene and cleanliness standards') }}</p>

    <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Room Setup and Maintenance:') }}</span></p>
    <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Efficient room preparation for new guests') }}</p>

    <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Laundry Management:') }}</span></p>
    <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Best practices in linen care and laundry operations') }}</p>

    <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Inventory Control:') }}</span></p>
    <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Managing room supplies, amenities, and housekeeping stock') }}</p>

    <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Guest Room Personalization:') }}</span></p>
    <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Creating memorable guest experiences through room touches') }}</p>
  ...
  <div class="program">
    <div class="program-text">
      ...
      <h1 data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Food and Beverage Service Excellence (1 Month)') }}</h1>
      </div>
      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Service Etiquette:') }}</span></p>
        <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate(' Professional table settings, order taking, and serving techniques') }}</p>

      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Menu Knowledge:') }}</span></p>
        <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate(' Understanding food and beverage offerings and pairing recommendations') }}</p>

      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Bar and Beverage Service:') }}</span></p>
        <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate(' Training on barista skills, cocktail preparation, and wine service') }}</p>

      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- F&B Hygiene:') }}</span></p>
        <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate(' Ensuring food safety and cleanliness in the food preparation and serving areas') }}</p>

      <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Upselling Techniques:') }}</span></p>
        <p data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Maximizing revenue through effective upselling without compromising guest experience') }}</p>
  ...
  <div class="program">
    ...
    <div class="program-text">
      <h1 data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Leadership and Team Building for Management (1 Month)') }}</h1>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Effective Leadership:') }}</span></p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Developing leadership styles that inspire and motivate staff') }}</p>

      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Team Coordination:') }}</span></p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Training on inter-departmental communication and collaboration') }}</p>

      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200"><span class="warna">-{{ $translator->translate(' Conflict Resolution:') }}</span></p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Managing staff disputes and maintaining a positive work environment') }}</p>

      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Time Management:') }}</span></p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Techniques for managing workloads and prioritizing tasks') }}</p>

      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Performance Management:') }}</span></p>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Coaching, mentoring, and evaluating staff performance') }}</p>
  ...
  <div class="program">
    <div class="program-text">
      <div class="program-title">
        <h1 data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Health, Safety, and Hospitality Laws (1 Month)') }}</h1>
      </div>
      <p  data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Safety Protocols:') }}</span></p>
      <p  data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Emergency procedures, fire drills, and staff safety') }}</p>

      <p  data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Workplace Hygiene and Sanitation:') }}</span></p>
      <p  data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Best practices for maintaining a safe and clean ') }}</p>

      <p  data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Labor Laws:') }}</span></p>
      <p  data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Training on employee rights and labor laws applicable to the hospitality industry') }}</p>

      <p  data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- First Aid and CPR:') }}</span></p>
      <p  data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate(' Basic training for staff to handle medical emergencies') }}</p>
  ...
  <div class="program">
    ...
    <div class="program-text">
      <h1 data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Custom Modules and Ongoing Development (Flexible)') }}</h1>
      <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Tailored Content Based on the specific needs of your hotel, additional modules may include:') }}</span></p>
       <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate(' •	Spa and Wellness Training 
        ') }}<br>
      {{ $translator->translate('  •	Event Management and Planning
        ') }}<br>
       {{ $translator->translate(' •	Digital Marketing and Social Media for Hospitality
        ') }}<br>
       {{ $translator->translate(' •	Sales and Revenue Management
        ') }}</p>
        <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200"><span class="warna">{{ $translator->translate('- Ongoing Development:') }}</span></p> 
        <p data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">{{ $translator->translate('Periodic refresher courses, skill assessments, and performance evaluations to ensure sustained excellence.') }}</p>
...
<section class="highlights">
    ...
    <div class="container-card">
      <div class="card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
          <h3>{{ $translator->translate('Tailored to Your Hotels Needs') }}</h3>
          <p>{{ $translator->translate('The training is customized based on your hotel’s unique requirements, size, and target market.') }}</p>
      </div>
      <div class="card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
          <h3>{{ $translator->translate('Industry Experts') }}</h3>
      ...
      <div class="card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
          <h3>{{ $translator->translate('Practical, Hands-On Learning') }}</h3>
          <p>{{ $translator->translate('Staff will receive practical training in real hotel settings, ensuring the skills are immediately applicable.') }}</p>
      </div>
      <div class="card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
          <h3>{{ $translator->translate('Ongoing Support') }}</h3>
          <p>{{ $translator->translate('Post-training support is available to ensure the continued success of the program and track the improvement in staff performance.') }}</p>
      </div>
      <div class="card" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
          <h3>{{ $translator->translate('Certified Trainers') }}</h3>
          <p>{{ $translator->translate('Trainers are certified experts in hospitality management and customer service excellence.') }}</p>
      </div>
  </div>
</section> 
...
<section class="Delivery">
  ...
  <div class="container-title6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
    <h2>{{ $translator->translate('Program Delivery Options') }}</h2>
  </div>
</div>
  <div class="Delivery-Options">
    <div data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
      <i class="fa-solid fa-bell"></i>
      <h3>{{ $translator->translate('On-Site Training') }}</h3>
     <p>{{ $translator->translate('
      Trainers come to your hotel for on-site sessions, working directly with staff in their familiar environment.
      ') }}</p>
    </div>
    <div data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
      <i class="fa-solid fa-book"></i>
      <h3>{{ $translator->translate('Blended Learning') }}</h3>
     <p>{{ $translator->translate('
      A combination of in-person training and online resources for continuous learning.
      ') }}</p>
    </div>
    <div data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
      <i class="fa-solid fa-microphone"></i>
      <h3>{{ $translator->translate('Workshops and Seminars') }}</h3>
     <p>{{ $translator->translate('
      Shorter, focused training sessions on specific topics, such as upselling techniques or hospitality etiquette.
      ') }}</p>
    </div>
   </div>
