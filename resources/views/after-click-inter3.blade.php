    ...
    <div class="container">
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('Students complete courses in an Australian school, learning best practices in sustainability, guest relations, and service excellence.') }}</p>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('The program includes supervised hands-on training sessions in local hotels and resorts.') }}</p>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('Cultural immersion activities help students understand and adapt to Australian hospitality standards.') }}</p>
            </div>
