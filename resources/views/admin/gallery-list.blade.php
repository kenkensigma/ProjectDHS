                        ...
                        <tbody>
                            @foreach ($gallery as $ondesk => $content)
                                <tr>
                                    ...
                                    <td>
                                      <img src="{{ asset('storage/' . $content->images) }}" width="80" height="70" alt="Image">
                                    </td> <!-- Gambar -->
                                    ...
                                    <td>
                                      <a href="{{ route('gallery.edit', $content->id) }}" class="btn btn-info btn-sm">
                                            <i class="bi bi-pen"></i> Edit
                                        </a>

                                        <form action="{{ route('gallery.destroy', $content->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus foto ini?');">
                                          @csrf
                                          @method('DELETE')
