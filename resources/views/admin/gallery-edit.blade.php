...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                  <form action="{{ route('gallery.update', $gallery->id) }}" method="POST" enctype="multipart/form-data" class="custom-validation">
                    @csrf
                    @method('PUT')                          
    ...
    <div class="form-group mb-3 col-md-6">
        ...
        <input type="file" id="images" name="images" class="form-control dropify" data-max-file-size="2M" 
            data-allowed-file-extensions="jpg png jpeg" required data-default-file="{{ asset('storage/' . $gallery->images) }}"/>
