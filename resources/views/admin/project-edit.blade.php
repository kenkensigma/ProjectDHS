    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                  <form action="{{ route('project.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf 
                    @method('PUT')                   
                    ...
                    <div class="row">
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <select class="form-control" name="category" required >
                                ...
                                <option value="Beasiswa" {{ old('category', $news->category ?? '') == "Beasiswa" ? 'selected' : '' }}>Beasiswa</option>
                                <option value="Pendidikan" {{ old('category', $news->category ?? '') == "Pendidikan" ? 'selected' : '' }}>Pendidikan</option><!-- Ubah jadi string -->
                            </select>   
                        </div>
                        <div class="form-group mb-3 col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group mb-3 col-md-6">  
                            ...
                            <input type="file" id="photo" name="photo" class="form-control dropify" data-max-file-size="2M" data-allowed-file-extensions="jpg png jpeg" data-default-file="{{ asset('storage/' . $news->photo) }}"
                            />
                    ...
                    <div class="row">
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <input type="text" name="caption_image" id="caption_image" class="form-control" value="{{ $news->caption_image }}">
                        </div>
                        <diiv class="form-group mb-3 col-md-6">
                            <label for="tags" class="form-label">Tags</label>
                            <input type="text" name="tags" id="tags" class="form-control" value="{{$news->tags }}">
                        </diiv>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <input type="text" name="keyword" id="keyword" class="form-control" value="{{ $news->keyword }}">
                        </div>
                        <div class="form-group mb-3 col-md-3">
                            <label for="hit" class="form-label">Hit</label>
                            <input type="number" name="hit" id="hit" class="form-control" value="{{ $news->hit }}">
                        </div>
                        <div class="form-group mb-3 col-md-3">
                            <label for="status" class="form-label">Status</label>
                            <select class="form-control" name="status" value="{{$news->status}}" required>
