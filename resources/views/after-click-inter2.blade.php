    ...
    <div class="container">
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('Students alternate between classroom sessions and hands-on work at hotels, restaurants, or resorts in Germany.') }}</p>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('Denpasar Hotel School offers German language and cultural preparation courses, helping students adapt to the German work environment.') }}</p>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('Successful graduates earn a certification recognized in the EU, with options to pursue employment in Germany or other European countries upon completion.') }}</p>
            </div>
