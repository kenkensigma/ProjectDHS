    ...
    <div class="container">
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('Training is conducted in both Indonesia and the European country, covering traditional European culinary techniques alongside Southeast Asian cuisine.') }}</p>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('After completing studies, students intern in renowned European kitchens, experiencing the fast-paced environment and high standards of the European culinary scene.') }}</p>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('Students learn to work in diverse, multicultural teams, a key skill in the international culinary industry.') }}</p>
            </div>
