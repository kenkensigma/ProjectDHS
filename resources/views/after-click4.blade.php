        ...
        <div class="container">
            <div class="card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    ...
                    <p>{{ $translator->translate('This program trains aspiring chefs and kitchen managers in advanced cooking, menu planning, kitchen operations, cost control, and staff coordination, preparing them for leadership roles in professional kitchens and restaurant management.') }}</p>
                </div>
            ...
            <div class="card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="200">
                <div class="card-content">
                    ...
                    <p>{{ $translator->translate('The Professional Food and Beverage Management Program at Denpasar Hotel School trains participants in managing food and beverage operations, focusing on service excellence, inventory control, menu design, and team leadership, preparing them for managerial roles in the hospitality industry.') }}</p>
                </div>
