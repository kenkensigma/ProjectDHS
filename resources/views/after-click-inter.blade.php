   ...
   <header class="header">
        <nav class="navbar">
            <ul class="nav-links left">
                ...
                <li class="dropdown">
                    <a href="#program" class="dropbtn">{{ $translator->translate('Program ') }}<i class="fas fa-chevron-down"></i></a>
                    <div class="dropdown-content">
    ...
    <div class="container">
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('After completing the initial training in Bali, students can participate in an internship at a partnered hotel or resort in Australia, gaining real-world experience in an international setting.') }}</p>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('Upon completion, students receive a certificate from both Denpasar Hotel School and the Australian partner, enhancing employability in the global market.') }}</p>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <p>{{ $translator->translate('Training modules emphasize skills in line with Australian hospitality and service standards.') }}</p>
            </div>
